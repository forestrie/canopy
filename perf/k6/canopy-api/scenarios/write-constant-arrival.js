...
// Load pre-generated payment pool from file (generated by workflow step).
// SharedArray ensures the data is loaded once and shared across all VUs.
const paymentPool = new SharedArray("x402-payments", function () {
  // This file is generated by the workflow before k6 runs
  const data = open("../data/x402-payment-pool.json");
...
export function setup() {
  ...
  console.log(`  x402: loaded ${paymentPool.length} pre-generated payments`);
