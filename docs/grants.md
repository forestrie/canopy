...
3. `grantData` non-empty; the **signer source** is resolved from exactly one place ([devdocs ADR-0065 §4](https://github.com/forestrie/protocol/blob/main/decisions/adr-0065-endorsed-session-key-admission.md), `scrapi/endorsed-signer.ts`):
