 ...
 *
 * Legacy module name; mirrors
 * [arbor sealer](https://github.com/forestrie/arbor/blob/main/services/sealer/)
 * delegationcert rules for payload field 5 (integer-key COSE_Key). Prefer
 * {@link validateByokDelegationCertificate} in validate-byok-certificate.ts.
 *
...
/** Thrown when material bytes fail structural or crypto validation. */
...
/** Normalize unknown errors into {@link ByokMaterialValidationError}. */
...
/**
 * Validate BYOK delegation material before DO persistence.
 *
 ...
 * @throws {@link ByokMaterialValidationError} when validation fails.
 */
