/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b64071b69b6c72cdd45269caa7c98336)
// Runtime types generated with workerd@1.20260521.1 2024-10-01 nodejs_compat_v2
interface __BaseEnv_Env {
  ...
  X402_SETTLEMENT_DO: DurableObjectNamespace<
    import("./src/index").X402SettlementDO
  >;
  RECEIVABLES_DO: DurableObjectNamespace<import("./src/index").ReceivablesDO>;
}
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("./src/index");
    durableNamespaces: "X402SettlementDO" | "ReceivablesDO";
  }
  interface DevEnv {
    R2_GRANTS: R2Bucket;
