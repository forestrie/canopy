/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d685425044f95ea1afbc4b9952951022)
// Runtime types generated with workerd@1.20251008.0 2024-10-01 nodejs_compat_v2
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SequencingQueue";
	}
	interface Env {
		NODE_ENV: "dev" | "prod";
		CANOPY_ID: "canopy-dev-1" | "canopy-prod-1";
		SEQUENCING_QUEUE: DurableObjectNamespace<import("./src/index").SequencingQueue>;
	}
}
